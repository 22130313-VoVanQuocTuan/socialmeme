...
from app.models import user, meme, trend_prediction
...
# Import Base từ database và tất cả models
...
# Override sqlalchemy.url with the one from our app config (which reads .env)
